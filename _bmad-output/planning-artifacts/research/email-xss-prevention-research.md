...
const EmailViewer = ({ emailHtml }) => {
  ...
  return <div className="email-content" dangerouslySetInnerHTML={{ __html: sanitizedHtml }} />
}
  ...
  setupHooks() {
    ...
    DOMPurify.addHook('uponSanitizeAttribute', (node, data) => {
      if (data.attrName === 'style') {
        ...
        const hasBlockedPattern = dangerousPatterns.some((pattern) => pattern.test(data.attrValue))
